...
const platformAnchors = [
  {
    ...
    short: "Weak PPG waveform extraction under low PI conditions.",
    href: "#low-perfusion",
  },
  {
    id: "motion-artifact",
    title: "Motion Artifact Rejection",
    short: "Motion-aware filtering for unstable finger contact.",
...
const jsonLd = [
  {
    ...
    description:
      "YimiLife PulseMatrix™ Signal Platform for low-perfusion SpO2 tracking, motion artifact rejection, skin-tone-aware signal design, engineering stack and production verification workflows.",
    publisher: {
      "@type": "Organization",
      name: "YimiLife",
    },
