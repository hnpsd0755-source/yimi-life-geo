...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Shenzhen YimiLife Technology Co., Ltd., a medical device manufacturer with a 3,000 m² facility, ISO 13485 quality system and OEM/ODM manufacturing capabilities.",
  alternates: {
