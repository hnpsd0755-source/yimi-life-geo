...
var Scheduler = __webpack_require__(433),
  React = __webpack_require__(431),
...
var jsx_runtime = __webpack_require__(295);
// EXTERNAL MODULE: ../../../../node_modules/react/index.js
var react = __webpack_require__(431);
// EXTERNAL MODULE: ../../../../node_modules/react-dom/client.js
var client = __webpack_require__(827);
;// ./src/image.tsx


function Image({ fill, priority, unoptimized, quality, loader, onLoadingComplete, ...props }) {
    const src = typeof props.src === 'object' ? props.src.src : props.src;
    return (0,jsx_runtime.jsx)("img", { ...props, src: src, style: fill ? { position: 'absolute', height: '100%', width: '100%', inset: 0, ...props.style } : props.style });
}

;// ./src/oem-odm-process-flow.module.css
/* harmony default export */ const oem_odm_process_flow_module = ({"panel":"panel","depth-card":"depth-card","card-surface":"card-surface"});
;// ./src/oem-odm-process-flow.tsx
"use client";
...
function StageIcon({ name }) {
    ...
    if (name === "scope") {
        return ((0,jsx_runtime.jsxs)("svg", { ...commonProps, children: [(0,jsx_runtime.jsx)("path", { d: "M8 5.5h8M8 9.5h8M8 13.5h5", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round" }), (0,jsx_runtime.jsx)("path", { d: "M7 3.5h10a3 3 0 0 1 3 3v11a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-11a3 3 0 0 1 3-3Z", stroke: "currentColor", strokeWidth: "1.8" })] }));
    }
    if (name === "artwork") {
        return ((0,jsx_runtime.jsxs)("svg", { ...commonProps, children: [(0,jsx_runtime.jsx)("path", { d: "m5 17 1.2-4.4L15.8 3l5.2 5.2-9.6 9.6L7 19l-2-2Z", stroke: "currentColor", strokeWidth: "1.8", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "m13.8 5 5.2 5.2M7 19l4.4-1.2", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round" })] }));
    }
    if (name === "sample") {
        return ((0,jsx_runtime.jsxs)("svg", { ...commonProps, children: [(0,jsx_runtime.jsx)("path", { d: "m12 3 8 4.5v9L12 21l-8-4.5v-9L12 3Z", stroke: "currentColor", strokeWidth: "1.8", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "m4.5 7.8 7.5 4.3 7.5-4.3M12 12v8.4", stroke: "currentColor", strokeWidth: "1.8", strokeLinejoin: "round" })] }));
    }
    return ((0,jsx_runtime.jsxs)("svg", { ...commonProps, children: [(0,jsx_runtime.jsx)("path", { d: "M4 20V9l5 3V8l5 3V4h6v16H4Z", stroke: "currentColor", strokeWidth: "1.8", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M8 16h2M14 16h2M18 8h2", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round" })] }));
}
function OemOdmProcessFlow({ headingLevel = "h2", activePath: controlledPath, onPathChange, }) {
    const [internalPath, setInternalPath] = (0,react.useState)("oem");
    ...
    return ((0,jsx_runtime.jsx)("section", { className: "bg-slate-50", "aria-labelledby": "project-flow-title", children: (0,jsx_runtime.jsxs)("div", { className: "site-container py-16 lg:py-20", children: [(0,jsx_runtime.jsxs)("div", { className: "max-w-5xl", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("span", { className: "inline-flex rounded-full border border-brand-200 bg-brand-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-800", children: "OEM / ODM Process" }), (0,jsx_runtime.jsx)(Heading, { id: "project-flow-title", className: "mt-5 text-4xl font-semibold leading-tight tracking-tight text-slate-950 md:text-5xl", children: "OEM & ODM Project Workflow" })] }), (0,jsx_runtime.jsx)("div", { className: "mt-7 grid max-w-2xl grid-cols-2 rounded-2xl border border-slate-200 bg-white p-1.5 shadow-sm", role: "tablist", "aria-label": "Choose OEM or ODM project flow", children: Object.keys(processPaths).map((path) => ((0,jsx_runtime.jsx)("button", { id: `${path}-process-tab`, type: "button", role: "tab", "aria-selected": activePath === path, "aria-controls": "project-flow-panel", onClick: () => selectPath(path), className: `site-control min-h-12 px-4 py-2.5 text-left text-xs font-semibold transition sm:text-sm ${activePath === path
...
function prepareLogoPreview(dataUrl) {
...
function createDestinationToSourceTransform(corners) {
    const sourceCorners = [
        [0, 0],
...
function warpLogoToProductSurface(dataUrl) {
    return new Promise((resolve) => {
        ...
        logoImage.onload = () => {
            ...
            const fitScale = Math.min(availableWidth / logoImage.width, availableHeight / logoImage.height);
            const drawWidth = logoImage.width * fitScale;
            const drawHeight = logoImage.height * fitScale;
            sourceContext.drawImage(logoImage, (sourceCanvas.width - drawWidth) / 2, (sourceCanvas.height - drawHeight) / 2, drawWidth, drawHeight);
            ...
            const outputPixels = outputContext.createImageData(outputCanvas.width, outputCanvas.height);
...
function UploadIcon() {
    return ((0,jsx_runtime.jsx)("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: (0,jsx_runtime.jsx)("path", { d: "M12 16V4m0 0L7 9m5-5 5 5M5 15v4h14v-4", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2" }) }));
}
function RemoveIcon() {
    return ((0,jsx_runtime.jsx)("svg", { className: "h-4 w-4", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: (0,jsx_runtime.jsx)("path", { d: "m7 7 10 10M17 7 7 17", stroke: "currentColor", strokeLinecap: "round", strokeWidth: "2" }) }));
}
...
function ProductPreviewDemo({ children, embedded = false, sectionId, onColorChange, onLogoChange, onAdjustmentChange, } = {}) {
    ...
    const [logoTone, setLogoTone] = (0,react.useState)("original");
    const [logoScale, setLogoScale] = (0,react.useState)(defaultLogoAdjustments.scale);
    const [logoOffsetX, setLogoOffsetX] = (0,react.useState)(defaultLogoAdjustments.offsetX);
    const [logoOffsetY, setLogoOffsetY] = (0,react.useState)(defaultLogoAdjustments.offsetY);
    const [logoRotation, setLogoRotation] = (0,react.useState)(defaultLogoAdjustments.rotation);
    const [logoWidth, setLogoWidth] = (0,react.useState)(defaultLogoAdjustments.width);
    ...
    return ((0,jsx_runtime.jsx)("section", { id: sectionId, className: `${embedded ? "scroll-mt-20 bg-white py-16 lg:py-20" : "site-section"} overflow-hidden`, children: (0,jsx_runtime.jsxs)("div", { className: "site-container", children: [(0,jsx_runtime.jsxs)("div", { className: "mx-auto max-w-3xl text-center", children: [(0,jsx_runtime.jsx)("span", { className: "inline-flex rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-brand-700", children: embedded ? "OEM brand preview" : "Visual configurator demo" }), embedded ? ((0,jsx_runtime.jsx)("h2", { className: "mt-4 text-3xl font-semibold tracking-tight text-slate-950 md:text-4xl", children: "Configure Your Product & Brand Preview" })) : ((0,jsx_runtime.jsx)("h1", { className: "mt-4 text-3xl font-semibold tracking-tight text-slate-950 md:text-5xl", children: "Product Color & Logo Preview" })), (0,jsx_runtime.jsx)("p", { className: "mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600 md:text-base md:leading-8", children: "Choose a product model and shell color, then upload your logo and adjust its placement." })] }), (0,jsx_runtime.jsxs)("div", { className: "mt-10 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)]", children: [(0,jsx_runtime.jsxs)("div", { className: "grid lg:grid-cols-[minmax(19rem,0.72fr)_minmax(0,1.55fr)]", children: [(0,jsx_runtime.jsxs)("div", { className: "border-b border-slate-200 p-6 md:p-8 lg:border-b-0 lg:border-r", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [(0,jsx_runtime.jsx)("span", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-brand-700 text-xs font-semibold text-white", children: "1" }), embedded ? ((0,jsx_runtime.jsx)("h3", { className: "text-base font-semibold text-slate-950", children: "Product model" })) : ((0,jsx_runtime.jsx)("h2", { className: "text-base font-semibold text-slate-950", children: "Product model" }))] }), (0,jsx_runtime.jsxs)("label", { className: "mt-4 block text-xs font-semibold text-slate-700", children: ["Demo model", (0,jsx_runtime.jsx)("select", { "aria-label": "Product model", defaultValue: "pulse-oximeter-demo", className: "site-control mt-2 w-full border border-slate-200 bg-white px-3.5 py-2.5 text-sm font-semibold text-slate-900 outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-100", children: (0,jsx_runtime.jsx)("option", { value: "pulse-oximeter-demo", children: "Pulse Oximeter \u00B7 Demo Model" }) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "mt-8 border-t border-slate-200 pt-8", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [(0,jsx_runtime.jsx)("span", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-brand-700 text-xs font-semibold text-white", children: "2" }), embedded ? ((0,jsx_runtime.jsx)("h3", { className: "text-base font-semibold text-slate-950", children: "Shell color" })) : ((0,jsx_runtime.jsx)("h2", { className: "text-base font-semibold text-slate-950", children: "Shell color" }))] }), (0,jsx_runtime.jsx)("div", { className: "mt-4 grid grid-cols-3 gap-2", role: "radiogroup", "aria-label": "Shell color", children: colors.map((color) => {
                                                        const isActive = color.id === selectedColor;
                                                        return ((0,jsx_runtime.jsxs)("button", { type: "button", role: "radio", "aria-checked": isActive, onClick: () => {
                                                    ...
                                                    (0,jsx_runtime.jsx)("img", { src: logoPreview, alt: "Perspective-adjusted logo positioned on the product shell", className: "h-full w-full object-contain", style: {
                                                            filter: logoFilter,
                                                            mixBlendMode: logoTone === "light" ? "screen" : "multiply",
                                                            opacity: logoTone === "original" ? 0.88 : 0.92,
                                                        } })) : ((0,jsx_runtime.jsxs)("svg", { className: "h-full w-full", viewBox: `0 0 ${perspectiveCanvas.width} ${perspectiveCanvas.height}`, "aria-label": "Perspective logo placement area", role: "img", children: [(0,jsx_runtime.jsx)("polygon", { points: perspectiveCanvas.corners.map((point) => point.join(",")).join(" "), fill: selectedColor === "navy" ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.12)", stroke: selectedColor === "navy" ? "rgba(255,255,255,0.62)" : "rgba(71,85,105,0.58)", strokeWidth: "3", strokeDasharray: "10 8" }), (0,jsx_runtime.jsx)("text", { x: "292", y: "157", fill: selectedColor === "navy" ? "rgba(255,255,255,0.76)" : "rgba(71,85,105,0.7)", fontSize: "24", fontWeight: "600", letterSpacing: "3", textAnchor: "middle", transform: "rotate(24 292 157)", children: "YOUR LOGO" })] })) })] }), (0,jsx_runtime.jsx)("p", { className: "relative z-10 mx-auto max-w-2xl text-center text-xs leading-5 text-slate-500", children: "Visual reference only. Final color, artwork size and print position are confirmed during sampling." })] })] }), children] })] }) }));
}
...
const inputClassName = "site-control w-full border border-slate-200 bg-white px-3.5 py-2.5 text-sm font-normal text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-100";
function ArrowIcon({ className = "h-4 w-4" }) {
    return ((0,jsx_runtime.jsx)("svg", { className: className, viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: (0,jsx_runtime.jsx)("path", { d: "M5 12h14M13 6l6 6-6 6", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2" }) }));
}
function CheckIcon({ className = "h-5 w-5" }) {
    return ((0,jsx_runtime.jsx)("svg", { className: className, viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: (0,jsx_runtime.jsx)("path", { d: "M20 6 9 17l-5-5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.2" }) }));
}
function Badge({ children, inverse = false }) {
    return ((0,jsx_runtime.jsx)("span", { className: `inline-flex rounded-full border px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] ${inverse
            ? "border-brand-200/30 bg-brand-300/10 text-brand-100"
            : "border-brand-200 bg-brand-50 text-brand-700"}`, children: children }));
}
function OemOdmExperience({ faqs }) {
    ...
    const selectedOemNeedLabels = oemReviewOptions
        ...
        .map((item) => item.label);
    return ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsxs)("section", { className: "relative overflow-hidden border-b border-slate-200 bg-[#f3f7f8]", children: [(0,jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(8,168,174,0.10),transparent_32%),radial-gradient(circle_at_88%_88%,rgba(148,163,184,0.18),transparent_34%)]", "aria-hidden": "true" }), (0,jsx_runtime.jsx)("div", { className: "site-container relative py-14 md:py-16 lg:py-20", children: (0,jsx_runtime.jsxs)("div", { className: "grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14", children: [(0,jsx_runtime.jsxs)("div", { className: "max-w-2xl", children: [(0,jsx_runtime.jsx)(Badge, { children: "Medical Device OEM / ODM" }), (0,jsx_runtime.jsx)("h1", { className: "mt-5 text-4xl font-semibold leading-[1.08] tracking-tight text-slate-950 md:text-5xl lg:text-[3.45rem]", children: "Build Your Medical Device Project with YimiLife." }), (0,jsx_runtime.jsx)("p", { className: "mt-6 max-w-xl text-sm leading-7 text-slate-600 md:text-base md:leading-8", children: "Start from an existing YimiLife model for branding and packaging, or bring a new appearance, structure or function into an ODM feasibility review." }), (0,jsx_runtime.jsx)("div", { className: "mt-8 flex flex-col gap-3 sm:flex-row", children: [
                                                {
                                                    path: "oem",
                                                    label: "OEM",
                                        ...
                                        : selectedPath === "odm"
                                            ...
                                            : "Start with the path that matches your project." })] }), (0,jsx_runtime.jsxs)("div", { className: "mt-7 flex flex-col gap-3 sm:flex-row lg:mt-0", children: [selectedPath !== "odm" ? ((0,jsx_runtime.jsx)("button", { type: "button", onClick: () => choosePath("oem"), className: "button-primary", children: "Request My Brand Preview" })) : null, selectedPath !== "oem" ? ((0,jsx_runtime.jsx)("button", { type: "button", onClick: () => choosePath("odm"), className: "button-secondary", children: "Submit an ODM Brief" })) : null] })] }) })] }));
}
...
const faqs = [
    {
        ...
        answer: "Choose OEM when you want to start from an existing YimiLife model and use its available colors and configuration options. Choose ODM when the project requires a new appearance, structural modification, function development, tooling or an engineering prototype.",
    },
    {
        question: "Which models and colors are available for OEM?",
        answer: "The final selector will only show confirmed models and the existing colors available for each model. The current interactive preview uses one pulse oximeter demo with three placeholder colors until the confirmed model list and product images are provided.",
    },
    {
        question: "What appears in the instant OEM preview?",
        answer: "The instant preview shows the demo product, selected shell color and uploaded logo. The logo treatment, position, rotation, overall size, width and height can be adjusted for early communication; final artwork, material and production details require sample confirmation.",
    },
    {
        question: "How are packaging, labels, IFU, accessories and product options handled?",
        answer: "These requirements can be selected and included in the inquiry summary, but they do not generate an instant visual result. YimiLife will confirm the required scope and inputs before preparing related artwork or samples.",
    },
    {
        question: "Which logo file formats are accepted?",
        answer: "The OEM preview accepts one PNG, JPG or JPEG file up to 2 MB. The file can be replaced or removed before submission. A transparent-background PNG is recommended when available.",
    },
    {
        question: "What information is needed before an ODM feasibility review?",
        answer: "Share the product category, target market, required appearance, structure or function changes, expected quantity and a concise project brief. YimiLife will review the project scope and the next feasibility discussion path.",
    },
];
...
(0,client.createRoot)(document.getElementById('oem-root')).render((0,jsx_runtime.jsx)(OemOdmExperience, { faqs: faqs }));
const root = document.getElementById('oem-root');
new ResizeObserver(() => parent.postMessage({ type: 'oem-preview-height', height: Math.ceil(root.getBoundingClientRect().height) }, location.origin)).observe(root);
